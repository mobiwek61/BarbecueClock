...
clock7.jpg shown above is the latest version including improved comments in svg code.   
#### Download BarbecueClock from [https://github.com/mobiwek61/BarbecueClock](https://github.com/mobiwek61/BarbecueClock)  
...
- SVG is an editable text file language which specifies shapes, text, positioning, color and more. Generate basic layout with AI and edit by hand.   
